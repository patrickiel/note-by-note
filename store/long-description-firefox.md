...
- Cross-device sync is the only network request the extension ever makes. It is on by default and can be switched off in Settings, and it carries no audio: just your settings, markers, loops, snippets, and the page URLs and titles of the tracks in your library.
